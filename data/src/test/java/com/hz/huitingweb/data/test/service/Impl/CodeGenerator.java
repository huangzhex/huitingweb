package com.hz.huitingweb.data.test.service.Impl;

import com.google.common.base.CaseFormat;
import com.hz.huitingweb.data.constants.ProjectConstant;
import com.hz.huitingweb.data.test.service.ICodeGenerator;
...
public class CodeGenerator implements ICodeGenerator {
    ...
    //endregion
    //JDBC配置，请修改为你项目的实际配置
//    private static final String JDBC_URL = "jdbc:mysql://60.28.59.67:3306/tbi-sms";
//    private static final String JDBC_USERNAME = "tbi";
//    private static final String JDBC_PASSWORD = "desladmin";
//    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";
    ...
    private String PACKAGE_PATH_SERVICE = packageConvertPath(ProjectConstant.SERVICE_PACKAGE);//生成的Service存放路径
    private String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath(ProjectConstant.SERVICE_IMPL_PACKAGE);//生成的Service实现存放路径
    private String PACKAGE_PATH_CONTROLLER = packageConvertPath(ProjectConstant.CONTROLLER_PACKAGE);//生成的Controller存放路径

//    private static final String AUTHOR = "LT";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

//    public static void main(String[] args) {
        //genCode("tbi_passenger_evaluate");
...
//        genController(tableName, modelName);
    ...
    public void genService(String tableName, String modelName) {
        try {
            ...
            data.put("daoPackage",ProjectConstant.MAPPER_PACKAGE);
